            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb-content">
                        <h2 class="title">Phim <span>Lẻ</span></h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="?admin=client&mod=home&act=index">Trang Chủ</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Phim lẻ</li>
                            </ol>
                        </nav>
                    </div>
                </div>
