 <?php 
	...
	class Category extends Model{
		...
		public function create($data) {
			...
			if ($data['parent_id']==0) {
				$sql = "INSERT INTO categories(name,slug,description) VALUES ('".$data['name']."', '".$data['slug']."', '".$data['description']."')";
			}else {
				$sql = "INSERT INTO categories(name,parent_id,slug,description) VALUES ('".$data['name']."', '".$data['parent_id']."', '".$data['slug']."', '".$data['description']."')";
			}
